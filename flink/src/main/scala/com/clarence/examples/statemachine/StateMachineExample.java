...
package com.clarence.examples.statemachine;

import com.clarence.examples.statemachine.dfa.State;
import com.clarence.examples.statemachine.event.Alert;
import com.clarence.examples.statemachine.event.Event;
import com.clarence.examples.statemachine.generator.EventsGeneratorSource;
import com.clarence.examples.statemachine.kafka.EventDeSerializer;
...
public class StateMachineExample {
	...
	public static void main(String[] args) throws Exception {
		...
		if (params.has("kafka-topic")) {
			...
			// FlinkKafkaConsumer<Event> kafka = new FlinkKafkaConsumer<E>(kafkaTopic, new EventDeSerializer(), kafkaProps);
			FlinkKafkaConsumer kafka = null;
